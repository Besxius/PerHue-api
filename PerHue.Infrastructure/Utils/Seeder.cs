	...
	public class Seeder(PerHueDbContext dbContext)
	{
		...
		private IEnumerable<Color> GetColors()
		{
			return new List<Color>
			{
				...
				new() { Name = "Coral Cove", HexCode = "#FBC7C3" },
				...
				new() { Name = "Purple Kiss", HexCode = "#E4DFCF" },
				new() { Name = "Dark Desire Rose", HexCode = "#D55F8F" },
				new() { Name = "Snowpink", HexCode = "#F9C4BA" },
				new() { Name = "Cupcake Rose", HexCode = "#3D1144" },
				new() { Name = "Rose Sangria", HexCode = "#CC135C" },
				new() { Name = "Floral White", HexCode = "#FADFDE" },
				new() { Name = "Frosty Day", HexCode = "#F1C5C2" },
				new() { Name = "Azure Sky", HexCode = "#D0114D" },
				new() { Name = "Dusty Purple", HexCode = "#EED5D1" },
				new() { Name = "Coral Mantle", HexCode = "#F38593" },
				new() { Name = "Sweet Aqua", HexCode = "#D5527D" },
				new() { Name = "Maroon Oak", HexCode = "#511628" },
				new() { Name = "Soy Milk", HexCode = "#9E0131" },
				new() { Name = "Majestic Beige", HexCode = "#820829" },
				new() { Name = "Almond Rose", HexCode = "#4D3211" },
				new() { Name = "Coral Dune", HexCode = "#C28C2E" },
				new() { Name = "Cosmic Latte", HexCode = "#D8CDB9" },
				new() { Name = "Meadow Grass", HexCode = "#721B29" },
				new() { Name = "Dusty Olive", HexCode = "#F7D4C8" },
				new() { Name = "Pearl Sugar", HexCode = "#FDFAF3" },
				new() { Name = "Pink Pickled Turnips", HexCode = "#CFECF5" },
				new() { Name = "Green Jelly", HexCode = "#A9E2F5" },
				new() { Name = "Dark Raspberry", HexCode = "#8E6C90" },
				new() { Name = "Momo Peach", HexCode = "#FCD8CC" },
				new() { Name = "Glamour White", HexCode = "#550D0E" },
				new() { Name = "Dark Purple", HexCode = "#A13842" },
				new() { Name = "Imaginary Mauve", HexCode = "#FFF7EC" },
				new() { Name = "Luminescent Blue", HexCode = "#A8EAD5" },
				new() { Name = "Red Wrath", HexCode = "#CE8884" },
				new() { Name = "Winter's Day", HexCode = "#FBD3C4" },
				new() { Name = "Sky of the Ocean", HexCode = "#FDF8E8" },
				new() { Name = "Night Dive", HexCode = "#BED5AE" },
				new() { Name = "Dreamy Cloud", HexCode = "#7A7D68" },
				new() { Name = "Pink Nectar", HexCode = "#F6F3EE" },
				new() { Name = "Pale Rose", HexCode = "#E0DED2" },
				new() { Name = "Bonfire", HexCode = "#BDBBAD" },
				new() { Name = "Golden Rambler", HexCode = "#E0457F" },
				new() { Name = "Apple White", HexCode = "#F9F4DB" },
				new() { Name = "Moorland Mist", HexCode = "#E7D6AC" },
				new() { Name = "Honey Butter", HexCode = "#3CAD99" },
				new() { Name = "French Toast", HexCode = "#872657" },
				new() { Name = "Tomato Soup", HexCode = "#F47983" },
				new() { Name = "Tomato Sauce", HexCode = "#FFFCEB" },
				new() { Name = "Chocolate Eclair", HexCode = "#35063E" },
				new() { Name = "Dark Marmalade", HexCode = "#89687D" },
				new() { Name = "Toasted Barley Flakes", HexCode = "#FCD8CC" },
				new() { Name = "Gingerbread Latte", HexCode = "#FFF7EC" },
				new() { Name = "Pinkish Grey", HexCode = "#A7E0E9" },
				new() { Name = "Grim White", HexCode = "#F01159" },
				new() { Name = "Shy Pink", HexCode = "#DFF8FE" },
				new() { Name = "Blush Grey Rose", HexCode = "#82CDE5" },
				new() { Name = "Pepper Jelly", HexCode = "#003458" },
				new() { Name = "Blazing Autumn", HexCode = "#52A7CC" },
				new() { Name = "Green Daze", HexCode = "#A5D4DC" },
				new() { Name = "Majestic Mist", HexCode = "#F2F4F8" },
				new() { Name = "Naturally Calm", HexCode = "#DEE0E0" },
				new() { Name = "Ash Violet", HexCode = "#D8ABB7" },
				new() { Name = "Maple Red", HexCode = "#EDD5D8" },
				new() { Name = "Pumpkin Latte", HexCode = "#F57B51" },
				new() { Name = "Dying Leaves", HexCode = "#FBBC58" },
				new() { Name = "Dark Oak", HexCode = "#F7F8E2" },
				new() { Name = "Wisteria", HexCode = "#DFDECA" },
				new() { Name = "Risotto", HexCode = "#F4D59A" },
				new() { Name = "Green Chalk", HexCode = "#DE8626" },
				new() { Name = "Red Berry", HexCode = "#C93D21" },
				new() { Name = "Cinnamon Baked", HexCode = "#8E1A02" },
				new() { Name = "Powder Cake", HexCode = "#563A3D" },
				new() { Name = "Blueberry Bark", HexCode = "#9A4D36" },
				new() { Name = "Wood Bark", HexCode = "#E0D6C3" },
				new() { Name = "Creamy Mushroom", HexCode = "#B4977B" },
				new() { Name = "Dry Maple Leaf", HexCode = "#C6ADAD" },
				new() { Name = "Wild Brown", HexCode = "#F6F0F3" },
				new() { Name = "Rose Taupe", HexCode = "#DFD7DB" },
				new() { Name = "Auburn Wave", HexCode = "#CABBBE" },
				new() { Name = "Aria Ivory", HexCode = "#C62644" },
				new() { Name = "Veronese Peach", HexCode = "#F3AC61" },
				new() { Name = "Nyctophile Blue", HexCode = "#F6EFE3" },
				new() { Name = "Blue Dacnis", HexCode = "#8AD2C6" },
				new() { Name = "Chilly White", HexCode = "#9CA1B3" },
				new() { Name = "Morning Breeze", HexCode = "#CFD1DA" },
				new() { Name = "Black Safflower", HexCode = "#EBECEF" },
				new() { Name = "Chanterelle", HexCode = "#9593A4" },
				new() { Name = "Wild Oats", HexCode = "#B8223C" },
				new() { Name = "Sweet Cherry Red", HexCode = "#F3B062" },
				new() { Name = "Rosewood", HexCode = "#90772F" },
				new() { Name = "Raw Sunset", HexCode = "#402320" },
				new() { Name = "Anemone White", HexCode = "#CAA6DB" },
				new() { Name = "Novelle Peach", HexCode = "#FBC7C3" },
				new() { Name = "Heilroom Rose", HexCode = "#F7F4E7" },
				new() { Name = "Tropical Peach", HexCode = "#B6DF82" },
				new() { Name = "Magic Mint", HexCode = "#721B29" },
				new() { Name = "Calestra Grey", HexCode = "#9D653F" },
				new() { Name = "Offshore Mint", HexCode = "#DFD8CB" },
				new() { Name = "Frosted Glass", HexCode = "#22314A" },
				new() { Name = "Rhythmic Blue", HexCode = "#0096D1" },
				new() { Name = "Great Canyon", HexCode = "#FFF4EA" },
				new() { Name = "Cashew Delight", HexCode = "#A8EAD5" },
				new() { Name = "Dulce de Leche", HexCode = "#3EBDC6" },
				new() { Name = "Cocoa Dust", HexCode = "#302621" },
				new() { Name = "Cherry Bomb", HexCode = "#CBBDAD" },
				new() { Name = "Rice Bowl", HexCode = "#984F0E" },
				new() { Name = "Barley Seeds", HexCode = "#4A2619" },
				new() { Name = "Shadow Purple", HexCode = "#8D5F5B" },
				new() { Name = "Twilight Lavender", HexCode = "#D8A194" },
				new() { Name = "Snow Plum", HexCode = "#F9E7D8" },
				new() { Name = "Rose Marble", HexCode = "#ECC0A5" },
				new() { Name = "Archipelago Green", HexCode = "#080E2C" },
				new() { Name = "Shallow White", HexCode = "#44D6E9" },
				new() { Name = "Shallow Blue", HexCode = "#ECF4F1" },
				new() { Name = "Beachy Blue", HexCode = "#D1E0DB" },
				new() { Name = "Jazzy Jade", HexCode = "#342E37" },
				new() { Name = "Ambrosia Cake", HexCode = "#DEA81C" },
				new() { Name = "Whitewash", HexCode = "#ECDCC4" },
				new() { Name = "Cherry Blossom Pink", HexCode = "#8E1533" },
				new() { Name = "Storm Blue", HexCode = "#762014" },
				new() { Name = "Alpaca Wool", HexCode = "#D23520" },
				new() { Name = "Coral Rose", HexCode = "#FFFFFF" },
				new() { Name = "Brownish Red", HexCode = "#E57B30" },
				new() { Name = "Smoked Purple", HexCode = "#5B0004" },
				new() { Name = "Lavender Haze", HexCode = "#F85528" },
				new() { Name = "Violet Hush", HexCode = "#F9EFE5" },
				new() { Name = "Ghostly Grey", HexCode = "#E6D1BF" },
				new() { Name = "Sparkling Pink", HexCode = "#D186A0" },
				new() { Name = "Snow Mint", HexCode = "#FDF8E8" },
				new() { Name = "Mint Macaroon", HexCode = "#AAF0D1" },
				new() { Name = "Soft Blush", HexCode = "#9CADB3" },
				new() { Name = "White Smoke", HexCode = "#CFDADA" },
				new() { Name = "Silver Lake", HexCode = "#EBF2F2" },
				new() { Name = "Glacier Grey", HexCode = "#BBD5D8" },
				new() { Name = "Blue Haze", HexCode = "#CB6347" },
				new() { Name = "White Lilac", HexCode = "#DFCBB2" },
				new() { Name = "Lilac Frost", HexCode = "#CC9972" },
				new() { Name = "Heliotrope Grey", HexCode = "#8C533D" },
				new() { Name = "Brem Cake", HexCode = "#711E2B" },
				new() { Name = "Antarctic Deep", HexCode = "#B33B44" },
				new() { Name = "Woodland", HexCode = "#F1E7D6" },
				new() { Name = "Nocturnal Sea", HexCode = "#DABE85" },
				new() { Name = "Aquamarine Blue", HexCode = "#462B45" },
				new() { Name = "White Desert", HexCode = "#884A6F" },
				new() { Name = "Lavender Cream", HexCode = "#F5EAEF" },
				new() { Name = "Heavy Charcoal", HexCode = "#D0BCC4" },
				new() { Name = "Mystic Mist", HexCode = "#B7DF69" },
				new() { Name = "Concrete Jungle", HexCode = "#F4F1EC" },
				new() { Name = "Purple Starburst", HexCode = "#9EEBE2" },
				new() { Name = "Taffy Pink", HexCode = "#1FD8D8" },
				new() { Name = "Girly Nursery", HexCode = "#51C9C2" },
				new() { Name = "Antique Mauve", HexCode = "#EEE9CF" },
				new() { Name = "Blackcurrant", HexCode = "#FCFFF5" },
				new() { Name = "Watermelon Candy", HexCode = "#FEBAC6" },
				new() { Name = "Aquarelle Red", HexCode = "#182F53" },
				new() { Name = "Illusion Blue", HexCode = "#F9EEE2" },
				new() { Name = "Pearl Grey", HexCode = "#F57A4D" },
				new() { Name = "Ambitious Rose", HexCode = "#AEBE89" },
				new() { Name = "Lemon Meringue", HexCode = "#444251" },
				new() { Name = "Coal Black", HexCode = "#8D89A3" },
				new() { Name = "Gothic Gold", HexCode = "#E4E3E5" },
				new() { Name = "Vintage Ephemera", HexCode = "#CBCBCF" },
				new() { Name = "Soft Cashmere", HexCode = "#F5CDE6" },
				new() { Name = "Turquoise Blue", HexCode = "#FAF8F0" },
				new() { Name = "Luxor Gold", HexCode = "#CFF5EA" },
				new() { Name = "Olive Hint", HexCode = "#A7E9E1" },
				new() { Name = "Dirty White", HexCode = "#E3BCBC" },
				new() { Name = "Cinnamon Stick", HexCode = "#F4F4F4" },
				new() { Name = "Royal Fuchsia", HexCode = "#E0E0E0" },
				new() { Name = "Bright Sun", HexCode = "#C4C6C8" },
				new() { Name = "Bright Teal", HexCode = "#BEBCCB" },
				new() { Name = "Shimmering Blush", HexCode = "#F1EFF2" },
				new() { Name = "Matte Pink", HexCode = "#DDD7DC" },
				new() { Name = "Beryl Green", HexCode = "#A994A7" },
				new() { Name = "Cocoa Bean", HexCode = "#F1E1C9" },
				new() { Name = "Malibu Beige", HexCode = "#F57B51" },
				new() { Name = "Foggy Day", HexCode = "#FBBC58" },
				new() { Name = "Burlwood", HexCode = "#F7F8E2" },
				new() { Name = "Dark Indigo", HexCode = "#DFDECA" },
				new() { Name = "Turquoise Gemstone", HexCode = "#9C7627" },
				new() { Name = "Diamond Dust", HexCode = "#C9BA86" },
				new() { Name = "Gooseberry", HexCode = "#E8E3CC" },
				new() { Name = "Light Turquoise", HexCode = "#9C4A29" },
				new() { Name = "Vanilla Shake", HexCode = "#F340AF" },
				new() { Name = "Midday Sun", HexCode = "#FBDB14" },
				new() { Name = "Pink Sapphire", HexCode = "#FFFCEB" },
				new() { Name = "Midnight Badger", HexCode = "#01F9C6" },
				new() { Name = "Quiet Grey", HexCode = "#DD84A1" },
				new() { Name = "Classic Chalk", HexCode = "#FFBBBE" },
				new() { Name = "Wolf Grey", HexCode = "#FDF8E8" },
				new() { Name = "Neon Fuchsia", HexCode = "#CBE3B3" },
				new() { Name = "Peach Fizz", HexCode = "#4F3B38" },
				new() { Name = "Clear Moon", HexCode = "#C9C1B0" },
				new() { Name = "Nightly Aurora", HexCode = "#E5E1D8" },
				new() { Name = "Majestic Magenta", HexCode = "#9C6F69" },
				new() { Name = "Pisco Sour", HexCode = "#171D4B" },
				new() { Name = "Satin Latour", HexCode = "#2ED3C6" },
				new() { Name = "Strawberry Mousse", HexCode = "#F8F5E6" },
				new() { Name = "Pink Blush", HexCode = "#AFE19F" },
				new() { Name = "Pink Dogwood", HexCode = "#5FDED7" },
				new() { Name = "Aubergine", HexCode = "#FFFDF8" },
				new() { Name = "Brownish Purple", HexCode = "#FFDC8E" },
				new() { Name = "Parchment", HexCode = "#E22A77" },
				new() { Name = "Watercress Pesto", HexCode = "#575965" },
				new() { Name = "Plum Purple", HexCode = "#C3C4C8" },
				new() { Name = "Autumn Glory", HexCode = "#F8F8F6" },
				new() { Name = "Milk Soda", HexCode = "#939498" },
				new() { Name = "Frozen Margarita", HexCode = "#FA376C" },
				new() { Name = "Tropical Freeze", HexCode = "#FFA780" },
				new() { Name = "Spring Lily", HexCode = "#FAF8E0" },
				new() { Name = "Chamomile Tea", HexCode = "#9BEEC1" },
				new() { Name = "Chamoisee", HexCode = "#F03E9E" },
				new() { Name = "Cream Gold", HexCode = "#C0E876" },
				new() { Name = "Sunny", HexCode = "#F7F4E7" },
				new() { Name = "Red Safflower", HexCode = "#FAD2AD" },
				new() { Name = "Red Claret", HexCode = "#A4647F" },
				new() { Name = "Tangerine Cream", HexCode = "#F8ADB5" },
				new() { Name = "Sweet Peach", HexCode = "#FFF6FA" },
				new() { Name = "Rose Sugar", HexCode = "#F8D8D8" },
				new() { Name = "Molten Lava", HexCode = "#452B30" },
				new() { Name = "Lime Meringue", HexCode = "#74404C" },
				new() { Name = "Coconut Cream", HexCode = "#F3ECD8" },
				new() { Name = "Tropical Light", HexCode = "#C7C79E" },
				new() { Name = "Wood Charcoal", HexCode = "#631647" },
				new() { Name = "Mist Grey", HexCode = "#FF8B0D" },
				new() { Name = "Shy Beige", HexCode = "#FDFFF0" },
				new() { Name = "Stormy Strait Green", HexCode = "#E3E8CD" },
				new() { Name = "Sunflower Yellow", HexCode = "#97D7CB" },
				new() { Name = "White Romance", HexCode = "#FCF2C7" },
				new() { Name = "Tamy Thyme", HexCode = "#DBC797" },
				new() { Name = "Bright Winter Cloud", HexCode = "#9C765D" },
				new() { Name = "Cameo Rose", HexCode = "#DDC35D" },
				new() { Name = "Scotchtone", HexCode = "#F0EC73" },
				new() { Name = "Bright Rose", HexCode = "#C53B3D" },
				new() { Name = "Moonlight", HexCode = "#86213D" },
				new() { Name = "Yellow Jelly", HexCode = "#FFA286" },
				new() { Name = "Nasturtium Flower", HexCode = "#FCDCC8" },
				new() { Name = "Lusty Lips", HexCode = "#FFF4F2" },
				new() { Name = "Smudged Lips", HexCode = "#A5EACF" },
				new() { Name = "Blackout", HexCode = "#B33534" },
				new() { Name = "Saffron Mango", HexCode = "#E3E8CD" },
				new() { Name = "Daisy White", HexCode = "#FAFCEE" },
				new() { Name = "Red Flag", HexCode = "#A1DD70" },
				new() { Name = "Safflower Red", HexCode = "#464646" },
				new() { Name = "Birch White", HexCode = "#C4C4BC" },
				new() { Name = "Foggy Gray", HexCode = "#F4F4F4" },
				new() { Name = "Carbon", HexCode = "#DEDAD1" },
				new() { Name = "Oily Steel", HexCode = "#13A699" },
				new() { Name = "Arctic Fox", HexCode = "#FFD708" },
				new() { Name = "Foggy Dew", HexCode = "#FFF7ED" },
				new() { Name = "Bright Lettuce", HexCode = "#AAF0D1" },
				new() { Name = "Pale Beryl", HexCode = "#C7C6AB" },
				new() { Name = "Fuchsia Rose", HexCode = "#F9F5F0" },
				new() { Name = "Bubblegum", HexCode = "#F7E1D8" },
				new() { Name = "Whitewashed Fence", HexCode = "#EBCCB9" },
				new() { Name = "Briquette", HexCode = "#D11C5B" },
				new() { Name = "Coconut Pulp", HexCode = "#F6EED5" },
				new() { Name = "Pale Daffodil", HexCode = "#FAC600" },
				new() { Name = "Soft Orange", HexCode = "#EA4B1D" },
				new() { Name = "Red Pear", HexCode = "#D51D48" },
				new() { Name = "Celestial Coral", HexCode = "#F24463" },
				new() { Name = "Mango Cheesecake", HexCode = "#FAEDE7" },
				new() { Name = "Rose Harmony", HexCode = "#F7D3C3" },
				new() { Name = "Lady Pink", HexCode = "#242121" },
				new() { Name = "Aqua Island", HexCode = "#F8C25C" },
				new() { Name = "Velvet Black", HexCode = "#F8F3E3" },
				new() { Name = "Cherry Lush", HexCode = "#FF2047" },
				new() { Name = "Peach Puree", HexCode = "#D63447" },
				new() { Name = "Milk Glass", HexCode = "#FDC2B1" },
				new() { Name = "Parchment", HexCode = "#F57B51" },
				new() { Name = "Dry Maple Leaf", HexCode = "#F6EEDF" },
				new() { Name = "Caraway Seeds", HexCode = "#D1CEBD" },
				new() { Name = "Chanterelle", HexCode = "#333333" },
				new() { Name = "Toasted Barley Flakes", HexCode = "#9BA8A8" },
				new() { Name = "Gingerbread Latte", HexCode = "#EBEBE7" },
				new() { Name = "Wood Bark", HexCode = "#C8CEC4" },
				new() { Name = "Fresh Guacamole", HexCode = "#95CE67" },
				new() { Name = "Frosty Pine", HexCode = "#95ddda" },
				new() { Name = "Rose Taupe", HexCode = "#C74375" },
				new() { Name = "Auburn Wave", HexCode = "#EE778A" },
				new() { Name = "Aria Ivory", HexCode = "#FAF3E3" },
				new() { Name = "Veronese Peach", HexCode = "#FFFFFF" },
				new() { Name = "Nyctophile Blue", HexCode = "#E75A5F" },
				new() { Name = "Blue Dacnis", HexCode = "#FAFADC" },
				new() { Name = "Chilly White", HexCode = "#FEE698" },
				new() { Name = "Morning Breeze", HexCode = "#FDB15D" },
				new() { Name = "Black Safflower", HexCode = "#7B3638" }
			};
		}
